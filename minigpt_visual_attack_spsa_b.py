...
from minigpt_utils import visual_attacker_spsa_b, prompt_wrapper
...
my_attacker = visual_attacker_spsa_b.Attacker(args, model, targets, device=model.device, is_rtp=False)

adv_img_prompt = my_attacker.attack_unconstrained_spsa(text_prompt_template,
                                                  img=img,
                                                  batch_size=8,
                                                  num_iter=20000,
